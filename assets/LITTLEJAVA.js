function processar () {
 ...
 var resultado = document.getElementById("resultado"); // Seleciona a div com id="resultado"
  resultado.style.display = "block"; // Altera o estilo da div para exibir
  var operadora = ""; // Cria uma variável para armazenar a operadora recomendada
  ...
  if (melhorOP1 < melhorOP2 && melhorOP1 < melhorOP3) {
      operadora = "A";
      plano = "1";
  } else if (melhorOP2 < melhorOP1 && melhorOP2 < melhorOP3) {
      operadora = "B";
      plano = "2";
  } else {
      operadora = "C";
  ...
  resultado.innerHTML = `A operadora recomendada é ${operadora} e o plano recomendado é ${plano}.`;
}
